    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'updates',   icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', label: 'Upwork Updates' },
...
export default function Sidebar({ activePage, onNavigate, data, leads, isOpen, onClose }) {
  ...
  return (
    <>
      {/* Overlay backdrop — only visible on mobile when drawer is open */}
      <div
      ...
      <nav className={`sidebar${isOpen ? ' sidebar-open' : ''}`}>
        ...
        {role !== 'customer' && (
          <div className="nav-item" onClick={() => { setShowChangePwd(true); onClose?.(); }} style={{ marginTop: 8 }}>
            <svg className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
